...
ray job submit --address=${HEAD_IP}:${HEAD_PORT} \
  ...
  --runtime-env-json='{
        ...
        "env_vars": {
          ...
          "HF_HOME": "/scratch-ssd/'$USER'/.cache/huggingface",
          "XDG_CACHE_HOME": "/scratch-ssd/'$USER'/.cache",
          "WANDB_CACHE_DIR": "/scratch-ssd/'$USER'/.cache/wandb",
          "WANDB_DIR": "/scratch-ssd/'$USER'",
